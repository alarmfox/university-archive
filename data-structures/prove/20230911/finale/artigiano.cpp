...
// p =  span/penalty
// con il fattore di priorità p sto dando priorità ai lavori con alta priorità 
// tenendo in considerazione la sua durata: più la durata è alta, minore sarà la sua 
// priorità.
...
// un'altra soluzione può essere ottenuta con la programmazione dinamica
vector<int> schedule_dp(vector<struct job>& v) {
  return vector<int>(0);
}
